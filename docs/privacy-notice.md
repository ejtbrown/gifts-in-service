...
An AI assistant will help you describe skills, experience, hobbies, and interests you may be willing to share. Unfinished questions and answers, temporary memory of facts you established and topics you closed, and optional follow-up notes are saved securely for up to 30 days so you can return without the assistant losing earlier answers. They are deleted when you approve the profile or that period ends. Only the profile text you review and approve is available to authorized staff or used in volunteer search. Account, consent, security, and lifecycle records needed to operate the service are also retained. AWS services process the conversation and approved profile to provide the assistant and search functions.
