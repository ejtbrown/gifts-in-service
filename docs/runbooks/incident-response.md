...
2. Contain without collecting more personal data: block affected routes at WAF/CloudFront, cap/disable Lambdas, stop SES sends, revoke Cognito/member/staff sessions and staff trusted-browser registrations, and suspend deploy credentials as appropriate.
