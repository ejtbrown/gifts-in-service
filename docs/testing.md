...
- Deterministic AI evaluations cover discovery breadth, boundaries, prohibited-data redirection, self-reported caveats, evidence grounding, and prompt injection. Live Bedrock evaluation is manual and fictional-only.
